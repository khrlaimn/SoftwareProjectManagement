        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{ route('BusinessUnit.index') }}" aria-expanded="false">
                <span>
                ...
                <span class="hide-menu" href="{{ route('BusinessUnit.index') }}" >Home</span>
              </a>
            </li>
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                  <div class="message-body">
                    ...
                    <form action="{{ route('logout') }}" method="POST">
                        @csrf
                        <button class="btn btn-outline-primary mx-3 mt-2 d-block" type="submit">
                            {{ __('Logout') }}
                        </button>
                    </form>
